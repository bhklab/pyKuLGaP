...
def read_pdx_data(file_path):
    ...
    for pname in df.patient.unique()[1:5]:
        ...
        for cname in df_pat.treatment_conditions.unique():
            ...
            new_cat = TreatmentCondition(cname, source_id=pname, level=x_array, response=y_array,
            ...
            new_cat.x_cut = new_cat.response[new_cat.measurement_start:new_cat.measurement_end + 1]
